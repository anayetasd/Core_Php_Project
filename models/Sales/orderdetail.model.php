...
class OrderDetail implements JsonSerializable{
	...
	public function save(){
		global $db,$tx;
		$db->query("insert into {$tx}order_details(order_id,product_id,qty,price,vat,discount)values('$this->order_id','$this->product_id','$this->qty','$this->price','$this->vat','$this->discount')");
		return $db->insert_id;
	}
