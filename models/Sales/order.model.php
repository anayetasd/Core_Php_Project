...
class Order implements JsonSerializable{
	...
	public function save(){
		global $db,$tx;
		$db->query("insert into {$tx}orders(customer_id,order_date,delivery_date,shipping_address,order_total,remark,status_id,discount,vat)values('$this->customer_id','$this->order_date','$this->delivery_date','$this->shipping_address','$this->order_total','$this->remark','$this->status_id','$this->discount','$this->vat')");
		return $db->insert_id;
	}
