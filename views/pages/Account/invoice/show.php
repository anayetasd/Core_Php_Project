            ...
            <div class="col-auto">
                <table class="table table-sm table-borderless fs--1 text-end">
                    <tr>
                        ...
                        <td class="fw-semi-bold" id="subTotal"><?= number_format($total, 2) ?></td>
                    </tr>
                    <tr>
                        <th class="text-900">Tax 3%:</th>
                        <td class="fw-semi-bold" id="tax"><?= number_format($tax, 2) ?></td>
                    </tr>
                    <tr class="border-top">
                        <th class="text-900">Total:</th>
                        <td class="fw-semi-bold" id="netTotal"><?= number_format($netTotal, 2) ?></td>
                    </tr>
                    <tr class="border-top border-top-2 fw-bolder text-900">
                        <th>Amount Due:</th>
                        <td id="due"><?= number_format($netTotal, 2) ?></td>
                    </tr>
                    <tr>
                      <th colspan="5">
